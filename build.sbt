...
lazy val dispatch0112 = provider("dispatch0112").settings(
  libraryDependencies ++= List(
...
lazy val dispatch0113 = provider("dispatch0113").settings(
  libraryDependencies ++= List(
...
lazy val playws23 = provider("playws23").settings(
  libraryDependencies ++= List(
...
lazy val playws24 = provider("playws24").settings(
  libraryDependencies ++= List(
...
lazy val playws25 = provider("playws25").settings(
  libraryDependencies ++= List(
